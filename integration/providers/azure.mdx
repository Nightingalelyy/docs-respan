...
3. Your deployment name matches those listed on our [Models page](https://platform.keywordsai.co/platform/models)
...
Go to [Providers page](https://platform.keywordsai.co/platform/api/providers) and select Azure OpenAI.
...
Azure allows custom deployment names. You need to map your deployment name so Keywords AI knows which Azure deployment to call.
...
To specify models:
1. Go to the [Models page](https://platform.keywordsai.co/platform/models)
...
Use the standard Keywords AI endpoint with Azure credentials:
...
You can find the complete and up-to-date list [here](https://platform.keywordsai.co/platform/models).