---
title: "Inference"
description: "Use your own Inference credits through Keywords AI"
---

<CardGroup cols={1}>
  <Card title="Get Inference API key" icon="key" href="https://inference.ai/">
    Get your Inference API key from the Inference platform to start using Inference models through Keywords AI.
  </Card>
</CardGroup>
...
### Via code
Add `customer_credentials` parameter in your [request body](/api-endpoints/develop/gateway/chat-completions) to use your own Inference credits.
