...
## Prerequisites
- You have already created at least one prompt in Respan. Learn how to create a prompt [here](/documentation/products/prompt_management/creating_prompts/create_prompt).
