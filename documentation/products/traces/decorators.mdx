...
| ----------- | ------- | ----- |
| **Respan Native** | ✅ | Built-in tracing with Respan SDK |
| **OpenAI SDK** | ✅ | Python only |
| **OpenAI Agents SDK** | ❌ | Use trace processors instead - see [OpenAI Agents SDK integration](/integrations/development-frameworks/tracing/openai-agents-sdk) |
...
Once you've implemented decorators in your code and executed your workflows, you can view the traces in the Respan platform:
