...
description: "A guide on how to create and versiona prompt in Respan."
---

In this guide, we will walk you through the process of creating a new prompt in Respan and how to collaborate with your team.
...
1. `https://api.respan.ai/api/prompts/` - Create a new prompt.
2. `https://api.respan.ai/api/prompts/<prompt_id>/versions/` - Create a new version of a prompt.
...
Once you have created a prompt, you can find the prompt ID in the response, or you can go to the [Prompts page](https://platform.respan.ai/platform/prompts) and find the prompt ID in the prompt details.
