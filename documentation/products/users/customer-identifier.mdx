...
description: "Respan allows you to track user data and monitor the user's data in the platform."
---
## How does user analytics work?
On Respan, we built a [Users page](https://platform.respan.ai/platform/users) to help you understand your users and their behavior on your LLM applications. With our user analytics feature, you can;
...
response = client.chat.completions.create(
    ...
    extra_body={
        "customer_params": {
            ...
            "email": "hendrix@respan.ai" # optional parameter
        }
    }
)
```
...
After you send the user's data to Respan, there are 3 places you can see the user's data on the platform.
### 1. [Users page](https://platform.respan.ai/platform/users)
...
### 2. [Dashboard page](https://platform.respan.ai/platform/dashboard)
...
### 3. [Logs page](https://platform.respan.ai/platform/requests)
