...
<Note>Only Respan users who are using the **LLM proxy** can set budget for their users. See how to [set up LLM proxy](/get-started/quickstart/gateway) for more information.</Note>
