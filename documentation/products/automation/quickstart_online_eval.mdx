...
Once your condition and [evaluator](https://docs.respan.ai/documentation/products/evaluation/llm-evals/llm-evaluator) are ready, navigate to [Automations](https://platform.respan.ai/platform/monitors) and create a new **automation**.
