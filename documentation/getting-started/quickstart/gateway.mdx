...
<AccordionGroup>
  ...
  <Accordion title="Respan Parameters">
    Use these when you want to achieve specific goals. For example, you can use `fallback_models` to specify fallback models when the primary model is down. You can check out all [Respan parameters in this page](/api-endpoints/develop/gateway/chat-completions#respan-parameters).
  </Accordion>
</AccordionGroup>
