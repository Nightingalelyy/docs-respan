...
### Respan params
You can pass any [Respan observability parameters](https://docs.respan.ai/api-endpoints/develop/gateway/chat-completions#observability-parameters) in the `metadata` field.
