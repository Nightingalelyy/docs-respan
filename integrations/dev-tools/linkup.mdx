...
If you're using [Respan Prompts](/documentation/products/prompt_management/quickstart), you can include the Linkup template variables in your prompt templates. When you make a request with `linkup_params`, the variables will be populated and rendered in your prompt.
