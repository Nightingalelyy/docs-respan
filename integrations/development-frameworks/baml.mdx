...
Next, you'll modify the client registry to connect to Respan, enabling observability and analytics. Learn how to create a Respan API key [here](https://docs.respan.ai/get-started/llm-inference#1-get-your-respan-api-key).
...
Initialize a Respan client in BAML by switching the base URL and adding the RESPAN_API_KEY in the environmental variable. Learn how to create a Respan API key [here](https://docs.respan.ai/get-started/llm-inference#create-an-api-key).   
