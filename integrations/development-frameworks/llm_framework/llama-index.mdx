...
[Respan parameters](/api-endpoints/develop/gateway/chat-completions#respan-parameters) can be passed using `extra_body` for better handling and customization.
