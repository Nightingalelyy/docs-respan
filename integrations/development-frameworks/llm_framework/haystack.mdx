...
<Note> This integration is for the **Respan gateway**. For workflow tracing, see [Haystack Tracing](/integration/development-frameworks/tracing/haystack). </Note>
...
Use [Respan parameters](/api-endpoints/develop/gateway/chat-completions#respan-parameters) for advanced features:
