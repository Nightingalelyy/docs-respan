...
---
<Note>This integration is only for **Agent tracing**. If you are looking for the OpenAI integration with the AI gateway, please see the [OpenAI integration](/integrations/development-frameworks/llm_framework/openai/openai-sdk).</Note>
