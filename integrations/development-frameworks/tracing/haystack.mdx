...
<Note> This integration is for **workflow tracing**. For gateway features, see [Haystack Gateway](/integrations/development-frameworks/llm_framework/haystack). </Note>
...
<Card title="Haystack Gateway Integration" href="/integrations/development-frameworks/llm_framework/haystack" icon="link">
