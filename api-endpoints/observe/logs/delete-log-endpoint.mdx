---
title: Delete log
api: DELETE https://api.keywordsai.co/api/request-logs/{unique_id}/
---
...
<ParamField path="unique_id" type="string" required>
  The unique ID of the log to delete. You can get this from the [List Logs endpoint](/api-endpoints/observe/logs/list).
</ParamField>
...
```bash cURL
curl -X DELETE "https://api.keywordsai.co/api/request-logs/log_abc123.../" \
...
- [List Logs](/api-endpoints/observe/logs/list) - Get log IDs for deletion
- [Get Log](/api-endpoints/observe/logs/get-log-endpoint) - Verify log contents before deletion
- [Update Log](/api-endpoints/observe/logs/logs-update-endpoint) - Alternative: update metadata instead of deleting
