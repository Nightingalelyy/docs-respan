...
api: "GET https://api.respan.ai/api/users/list/"
---
...
<Info>Use your Respan API key in `Authorization: Bearer YOUR_API_KEY`.</Info>
...
base_url = "https://api.respan.ai/api/users/list/"
params = {
    "page": 1,
    "page_size": 50,
    "sort_by": "-first_seen",
...
```bash cURL
curl "https://api.respan.ai/api/users/list/?page=1&page_size=50&sort_by=-first_seen&environment=prod" \
